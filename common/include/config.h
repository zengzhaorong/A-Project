...
#define CAPTURE_PIX_WIDTH		(LCD_PIX_WIDTH*8/10)
...
#define FACE_RECOGN_THRES_80		80.0	// confidence = 80%
#define FACE_RECOGN_THRES_100		50.0	// confidence = 100%
